 ...
 *
 */
SinglyLinkedListNode* mergeLists(SinglyLinkedListNode* rear1, SinglyLinkedListNode* rear2) {
    if(rear1==NULL)
        return rear2;
    if(rear2==NULL)
        return rear1;
    if(rear1->data<rear2->data){
        rear1->next = mergeLists(rear1->next,rear2);
        return rear1;
    }
    else
    {
        rear2->next = mergeLists(rear1,rear2->next);
        return rear2;
    } 
}
